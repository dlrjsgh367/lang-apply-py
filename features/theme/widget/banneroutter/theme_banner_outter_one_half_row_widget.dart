...
class ThemeBannerOutterOneHalfRowWidget extends ConsumerStatefulWidget {
  const ThemeBannerOutterOneHalfRowWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerOutterOneHalfRowWidget> createState() =>
      _ThemeBannerOutterOneHalfRowWidgetState();
}

class _ThemeBannerOutterOneHalfRowWidgetState
    extends ConsumerState<ThemeBannerOutterOneHalfRowWidget> {
  int activeIndex = 0;
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            ...
            (CommonSize.vw * 0.9111 / 2 - 8.w) / 320 * 88 + 35.w + 20.w
            :
                        ...
                        SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                widget.moveUrl(widget.themeSettingList[index * 2 + i]);
                              },
                              child: Container(
                                    ...
                                    if (widget.themeData.displayViewTitle == 1)
                                      Padding(
                                        padding: EdgeInsets.fromLTRB(
                                            12.w, 8.w, 12.w, 8.w),
                                        child: Text(
                                          widget.themeSettingList[index * 2 + i]
                                              .title,
                                          maxLines: 1,
