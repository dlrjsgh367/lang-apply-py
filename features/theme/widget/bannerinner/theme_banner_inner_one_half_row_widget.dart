...
class ThemeBannerInnerOneHalfRowWidget extends ConsumerStatefulWidget {
  const ThemeBannerInnerOneHalfRowWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerInnerOneHalfRowWidget> createState() =>
      _ThemeBannerInnerOneHalfRowWidgetState();
}

class _ThemeBannerInnerOneHalfRowWidgetState
    extends ConsumerState<ThemeBannerInnerOneHalfRowWidget> {
  int activeIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return SliverMainAxisGroup(
      slivers: [
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            height: (CommonSize.vw * 0.9111 / 2 - 8.w) / 320 * 88 + 20.w,
            child: Swiper(
