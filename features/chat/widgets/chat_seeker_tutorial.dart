...
class ChatSeekerTutorial extends StatefulWidget {
  const ChatSeekerTutorial({super.key, required this.setTutorial});

  final Function setTutorial;

  @override
  State<ChatSeekerTutorial> createState() => _ChatSeekerTutorialState();
}

class _ChatSeekerTutorialState extends State<ChatSeekerTutorial> {
  @override
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Image.asset(
                            'assets/images/default/imgBalloonTuto04.png',
                            width: 270.w,
                          ),
                        ),
                        Row(
