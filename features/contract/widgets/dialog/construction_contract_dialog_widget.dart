...
class ConstructionContractDialogWidget extends ConsumerStatefulWidget {
  const ConstructionContractDialogWidget({
    super.key,
    required this.uuid,
  ...
  @override
  ConsumerState<ConstructionContractDialogWidget> createState() =>
      _ConstructionContractDialogWidgetState();
}

class _ConstructionContractDialogWidgetState
    extends ConsumerState<ConstructionContractDialogWidget> with Files {
  ...
  createPdf() async {
    ...
    final pdfFirstColumn = await ContractTemplate.returnNormalFistContract(
        params, user, signImgData!, null, false, 'CONSTRUCTION', null);

    String today = DateFormat('yyyyMMdd').format(DateTime.now());

    String documentTitle =
        '${localization.constructionDailyEmployeeContract}_${params['ccdEmployeeName']}_${user!.companyInfo!.name}_$today';
  ...
  sendContract() async {
    if (widget.chatUsers.isNotEmpty && pdfFile != null) {
      var apiUploadResult = await ref
          ...
          .createContract(widget.uuid, 'CONSTRUCTION', params, 1);
  ...
  updateContract() async {
    if (widget.chatUsers.isNotEmpty && pdfFile != null) {
      var apiUploadResult = await ref
          .read(chatControllerProvider.notifier)
          .createContract(widget.uuid, 'CONSTRUCTION', params, 2);
  ...
  sendUpdateDocumentMsg(int caIdx) async {
    ...
    String chatValue = localization.constructionDailyContractEditNotice(createTime);
  ...
  setInitValue() {
    ...
    setState(() {
      params = {
        ...
        "ccdWorkingEndTime": convertTime(detailData.ccdWorkingEndTime),
    ...
    loadingTimer = Timer(const Duration(milliseconds: 500), () {
      setState(() {
        isLoading = false;
      });
    });
      ...
      children: [
        PopScope(
          ...
          child: Scaffold(
            appBar: ModalAppbar(
              title:
                  widget.msgKey != null ? localization.constructionDailyWorkerContractEdit : localization.constructionDailyWorkerContractCreate,
            ),
                                  ...
                                  child: SignUpStepWidget(
                                    ...
                                    onTap: () {
                                      if (contractValidator['workDate'] &&
                                          contractValidator['workPlace'] &&
                                          contractValidator['jobDescription'] &&
                                          contractValidator['workingDays'] &&
                                          contractValidator['workingTime'] &&
                                          contractValidator['breakTime']) {
                                        setState(() {
                                          step = 1;
                                          _scrollController.jumpTo(0);
                                        });
                                  ...
                                  if (step == 2)
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 8.w),
                                        if (params['ccdPaymentMethodOther'] ==
                                            1)
                                          Column(
                                            children: [
                                              for (int i = 0;
                                                            ...
                                                            child:
                                                              ...
                                                              onChanged:
                                                                ...
                                                                params['otherSalaryClassList']
                                                                    ...
                                                                    ConvertService
                                                                        .convertStringToInt(
                                                                            ConvertService.removeAllComma(etcAmountControllerList[i].text));
                                                              },
                                                              style:
                                                                  commonInputText(),
                                                              decoration: suffixInput(
                                                              ...
                                                              children: [
                                                                ...
                                                                GestureDetector(
                                                                  onTap: () {
                                                                    setState(
                                                                        () {
                                                                      params['otherSalaryClassList'].remove(
                                                                          params['otherSalaryClassList']
                                                                              [
                                                                              i]);
                                                                    });
