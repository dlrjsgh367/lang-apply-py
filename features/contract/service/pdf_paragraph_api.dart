...
class PdfParagraphApi {
  static Future<File> generate() async {
    ...
    final customFont =
    Font.ttf(await rootBundle.load('assets/fonts/OpenSans_Condensed-Bold.ttf'));
    ...
    pdf.addPage(
      MultiPage(
        build: (context) => <Widget>[
          ...
          buildLink(),
          ...buildBulletPoints(),
          Header(child: Text('My Headline', style: TextStyle(font: customFont, fontSize: 20))),
          Paragraph(text: LoremText().paragraph(60), style: TextStyle(font: customFont, fontSize: 20)),
          Paragraph(text: LoremText().paragraph(60), style: TextStyle(font: customFont, fontSize: 20)),
          Paragraph(text: LoremText().paragraph(60), style: TextStyle(font: customFont, fontSize: 20)),
          Paragraph(text: LoremText().paragraph(60), style: TextStyle(font: customFont, fontSize: 20)),
          Paragraph(text: LoremText().paragraph(60), style: TextStyle(font: customFont, fontSize: 20)),
