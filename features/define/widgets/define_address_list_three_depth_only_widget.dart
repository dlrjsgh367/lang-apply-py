...
class DefineAddressListThreeDepthOnlyWidget extends ConsumerStatefulWidget {
  const DefineAddressListThreeDepthOnlyWidget(
      {required this.title,
  ...
  @override
  ConsumerState<DefineAddressListThreeDepthOnlyWidget> createState() =>
      _DefineAddressListThreeDepthOnlyWidgetState();
}

class _DefineAddressListThreeDepthOnlyWidgetState
    extends ConsumerState<DefineAddressListThreeDepthOnlyWidget> {
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: searchInput(
                  height: 50,
                  hintText: localization.searchRegion, clearFunc: (){
                          ...
                          return oneDepthData.child.isNotEmpty
                            ...
                            childArr: [
                              ListView.builder(
                                ...
                                itemCount: oneDepthData.child.length,
                                itemBuilder:
                                  ...
                                  return CollapseBtn(
                                      ...
                                      childArr: [
                                        ListView.builder(
                                          ...
                                          physics:
                                          const NeverScrollableScrollPhysics(),
                                          itemCount: twoDepthData.child.length,
                                          itemBuilder: (context, depthThreeIndex) {
                                              final threeDepthData = twoDepthData.child[depthThreeIndex];
                                              return GestureDetector(
                                                onTap: () {
                                                  selectItem(threeDepthData, depth: 3);
                                                },
                                                child: FilterCheckBtn(
                                                  backColor:
                                                  CommonColors
                                                      .grayF2,
                                                  paddingLeft: 44,
                                                  active: selectedKeyList.contains(threeDepthData.key),
                                                  text:threeDepthData.dongName,
                                                ),
                                              );
