...
class _SetPasswordScreenState extends ConsumerState<SetPasswordScreen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertConfirmDialog(
          alertTitle: localization.changePassword,
          alertContent: localization.socialAccountPasswordChangeNote,
  ...
  updatePassword() async {
    ...
    if (result.status == 200) {
      setState(() {
        context.pop();
        showDefaultToast(localization.changeCompletedNotification);
      });
    }
  }
        ...
        children: [
          GestureDetector(
            ...
            child: Scaffold(
              ...
              body: CustomScrollView(
                slivers: [
                  const ProfileTitle(
                    title: localization.currentPassword,
                    required: false,
                    hasArrow: false,
                    text: '',
                  ),
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: TextFormField(
                        ...
                        maxLength: null,
                        decoration: passwordInput(
                          hintText: localization.passwordRequirementsNotice,
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: TextFormField(
                        ...
                        maxLength: null,
                        decoration: passwordInput(
                          hintText: localization.reenterPasswordPrompt,
          ...
          Positioned(
            ...
            child: CommonButton(
              ...
              fontSize: 15,
              text: localization.applyPasswordChange,
            ),
          ),
        ],
      ),
