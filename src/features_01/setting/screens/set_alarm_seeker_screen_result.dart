...
class _SetAlarmSeekerScreenState extends ConsumerState<SetAlarmSeekerScreen> {
  ...
  List employmentInfoArr = [
    {'title': localization.newRecommendedJobNotification, 'key': 'majRecommend', 'value': false},
    {'title': localization.nearbyJobPostNotification, 'key': 'majNearNewJobposting', 'value': false},
    {'title': localization.jobProposalReceptionNotification, 'key': 'majJobOffer', 'value': false},
    {'title': localization.scrapJobPostExpirationNotification, 'key': 'majScrap', 'value': false},
    {'title': localization.favoriteCompanyNewJobPostNotification, 'key': 'majNewRecruits', 'value': false},
  ];

  List jobSeekingArr = [
    {'title': localization.incompleteProfileNotification, 'key': 'majProfile', 'value': false},
    {'title': localization.jobApplicationNotification, 'key': 'majJobposting', 'value': false},
    {'title': localization.profileVisibilityNotification, 'key': 'majDisplayProfile', 'value': false},
  ];

  List chatArr = [
    {'title': localization.newChatNotification, 'key': 'majNewRoom', 'value': false},
    {'title': localization.messagePhotoFileNotification, 'key': 'majMessage', 'value': false},
    {'title': localization.employmentContractReceiptNotification, 'key': 'majEmployment', 'value': false},
    {'title': localization.salarySlipReceiptNotification, 'key': 'majSalary', 'value': false},
    {'title': localization.documentRejectionNotification, 'key': 'majDocumentRejection', 'value': false},
  ];
  ...
  List marketingArr = [
    {
      'title': localization.smsNotification,
      'key': 'maMarketingSms',
      'value': false,
      'target': localization.mobileTextNotification
    },
    {
      'title': localization.emailReceiptNotification,
      'key': 'maMarketingEmail',
      'value': false,
      'target': localization.emailNotification
    },
    {
      'title': localization.pushNotification,
      'key': 'maMarketingPush',
      'value': false,
      'target': localization.appPushNotification
    },
        ...
        ? CustomScrollView(
            slivers: [
              SliverPadding(
                ...
                sliver: TitleMenu(title: localization.jobInformationNotification),
              ),
              AlarmToggleRadioButton(
                text: localization.allJobInformationNotifications,
                isTop: true,
                onChanged: (value) {
              ...
              SliverPadding(
                ...
                sliver: TitleMenu(title: localization.jobSearchActivityNotification),
              ),
              AlarmToggleRadioButton(
                text: localization.allJobSearchActivityNotifications,
                isTop: true,
                onChanged: (value) {
