  ...
  updateUserInfo() async {
    ...
    if (userInfo != null) {
      ...
      if (result.status == 200) {
        setState(() {
          context.pop();
          showDefaultToast(localization.editCompletedNotification);
        });
      }
    }
    setState(() {
          ...
          children: [
            Scaffold(
                appBar: const CommonAppbar(
                  title: localization.editMemberInfo,
                ),
                body: isLoading
                    ? const Loader()
                    : userInfo != null
                                ...
                                sliver: SliverToBoxAdapter(
                                  child: Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: ReadOnlyUserInfoWidget(
                                          title: localization.dateOfBirth,
                                ...
                                sliver: SliverToBoxAdapter(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        localization.mobilePhoneNumber,
                                          ...
                                          SizedBox(
                                            ...
                                            child: !isCertificationCodeSent
                                              ? CommonButton(
                                                  ...
                                                  text: localization.verificationRequest,
                                                )
                                              : BorderButton(
                                                  width: 90.w,
                                                  red: true,
                                                  ...
                                                  text: localization.resendVerification,
                                                ),
                                          ),
                                        ],
                                      ),
                                      if (phoneNumberErrorMessage != '')
                                        phoneNumberErrorMessage == localization.mobileVerificationCompleted
                                            ? Row(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                Text(
                                                  localization.mobileVerificationCompleted,
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: CommonButton(
                                                ...
                                                text: localization.verificationCode,
                                              ),
                                            ),
                                          ],
                                        ),
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: CommonButton(
                                              confirm: true,
                                              onPressed: showPost,
                                              text: localization.addressSearch,
                                            ),
                                          ),*/
                                        ],
                                      ),
              ...
              Positioned(
                ...
                child: CommonButton(
                  confirm: ((userData['meHp'].isNotEmpty &&
                      ...
                      phoneNumberController
                          .text.isNotEmpty && phoneNumberErrorMessage.isEmpty || phoneNumberErrorMessage == localization.mobileVerificationCompleted),
                  onPressed: () {
                    if ((userData['meHp'].isNotEmpty &&
                        ...
                        && !isCertificationCodeSent) && !phoneNumberMatchRegex &&
                        phoneNumberController
                            .text.isNotEmpty && (phoneNumberErrorMessage.isEmpty || phoneNumberErrorMessage == localization.mobileVerificationCompleted) && !isConfirmLoading) {
                      updateUserInfo();
                    }
                  },
                  fontSize: 15,
