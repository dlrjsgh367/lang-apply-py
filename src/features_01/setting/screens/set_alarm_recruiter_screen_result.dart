...
class _SetAlarmRecruiterScreenState extends ConsumerState<SetAlarmRecruiterScreen> {
  ...
  List postArr = [
    {'title': localization.jobPostStatusNotification, 'key': 'marJobpostingState', 'value': false},
    {'title': localization.jobPostVisibilityNotification, 'key': 'marJobpostingDisplay', 'value': false},
  ];

  List recruitmentArr = [
    {'title': localization.incompleteCompanyInfoNotification, 'key': 'marCompanyIncomplete', 'value': false},
    {'title': localization.newRecommendedCandidateNotification, 'key': 'marNewRecommend', 'value': false},
    {'title': localization.newApplicantNotification, 'key': 'marNewApplicant', 'value': false},
    {'title': localization.proposalAcceptanceRejectionNotification, 'key': 'marOfferAllow', 'value': false},
    {'title': localization.favoriteCandidateNotification, 'key': 'marTalent', 'value': false},
  ];

  List chatArr = [
    {'title': localization.messagePhotoFileNotification, 'key': 'marMessage', 'value': false},
    {'title': localization.employmentContractNotification, 'key': 'marEmployment', 'value': false},
    {'title': localization.attendanceNotification, 'key': 'marAttendance', 'value': false},
    {'title': localization.documentArrivalNotification, 'key': 'marDocument', 'value': false},
  ];

  List premiumArr = [
    {'title': localization.shortTermCoinNotification, 'key': 'marChoco', 'value': false},
    {'title': localization.regionalTopExposureNotification, 'key': 'marRegionPriority', 'value': false},
    {'title': localization.chatExpirationNotification, 'key': 'marMessageEnd', 'value': false},
    {'title': localization.crazyMatchingNotification, 'key': 'marMadMatching', 'value': false},
    {'title': localization.brandThemeSectionNotification, 'key': 'marBrandTheme', 'value': false},
  ];

  List etcArr = [
    {'title': localization.laborConsultationReplyNotification, 'key': 'maQnaAlarm', 'value': false},
    {'title': localization.generalNotification, 'key': 'maNoticeAlarm', 'value': false},
  ];

  List marketingArr = [
    {'title': localization.smsNotification, 'key': 'maMarketingSms', 'value': false, 'target': localization.mobileTextNotification},
    {'title': localization.emailReceiptNotification, 'key': 'maMarketingEmail', 'value': false, 'target': localization.emailNotification},
    {'title': localization.pushNotification, 'key': 'maMarketingPush', 'value': false, 'target': localization.appPushNotification},
    {'title': localization.nightReceptionConsentStatus, 'key': 'maNightAlarm', 'value': false},
  ];
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertConfirmDialog(
          ...
          alertContent: '${DateFormat(localization.).format(now)}\n 마케팅 정보 수신 $agreeString($target) 처리되었어요.',
    ...
    ? CustomScrollView(
        slivers: [
          SliverPadding(
            ...
            sliver: TitleMenu(title: localization.jobPostNotification),
          ),
          AlarmToggleRadioButton(
            text: localization.allJobPostNotifications,
            isTop: true,
            onChanged: (value) {
          ...
          SliverPadding(
            ...
            sliver: TitleMenu(title: localization.recruitmentActivityNotification),
          ),
          AlarmToggleRadioButton(
            text: localization.allRecruitmentActivityNotifications,
            isTop: true,
            onChanged: (value) {
          ...
          SliverPadding(
            padding: EdgeInsets.fromLTRB(0, 42.w, 0, 8.w),
            sliver: TitleMenu(title: localization.matchingChatNotification),
          ),
          AlarmToggleRadioButton(
            text: localization.allMatchingChatNotifications,
            isTop: true,
            onChanged: (value) {
          ...
          SliverPadding(
            padding: EdgeInsets.fromLTRB(0, 42.w, 0, 8.w),
            sliver: TitleMenu(title: localization.premiumShortTermCoinNotification),
          ),
          AlarmToggleRadioButton(
            text: localization.allPremiumShortTermCoinNotifications,
            isTop: true,
            onChanged: (value) {
          ...
          SliverPadding(
            padding: EdgeInsets.fromLTRB(0, 42.w, 0, 8.w),
            sliver: TitleMenu(title: localization.otherNotification),
          ),
          AlarmToggleRadioButton(
            text: localization.allOtherNotifications,
            isTop: true,
            onChanged: (value) {
          ...
          SliverPadding(
            padding: EdgeInsets.fromLTRB(0, 42.w, 0, 8.w),
            sliver: TitleMenu(title: localization.marketingNotification),
          ),
          AlarmToggleRadioButton(
            text: localization.allMarketingNotifications,
            isTop: true,
            onChanged: (value) {
          ...
          for (var i = 0; i < marketingArr.length; i++)
            AlarmToggleRadioButton(
              ...
              caption: i == marketingArr.length - 1
                  ? localization.nightMarketingNotificationDetails
                  : null,
              onChanged: (value) {
