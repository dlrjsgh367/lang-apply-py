    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertConfirmRedDialog(
          alertContent: localization.checkAndSaveInput,
          redText: '금칙어: [$forbiddenWord]',
          alertConfirm: localization.confirm,
          confirmFunc: () {
            context.pop();
          },
          alertTitle: localization.prohibitedWordDetected,
        );
      },
    );
  }
          ...
          child: Scaffold(
            body: CustomScrollView(
              slivers: [
                  ...
                  sliver: SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          localization.selfIntroductionOrKeywordRequired,
                          style: TextStyle(
                            fontSize: 12.sp,
                            color: CommonColors.gray80,
                ...
                //   GestureDetector(
                //     onTap: _loadMore,
                //     child: const Text(localization.seeMore),
                //   ),
