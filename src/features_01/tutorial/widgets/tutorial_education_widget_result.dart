...
class _TutorialEducationWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    return !isLoading
                      ...
                      sliver: SliverToBoxAdapter(
                        child: Row(
                          children: [
                            Expanded(
                              child: Text(
                                localization.introduceYourEducation,
                                style: TextStyle(
                                  fontSize: 20.sp,
                                                  ...
                                                  showDialog(
                                                      ...
                                                      builder: (context) {
                                                        return AlertTwoButtonDialog(
                                                            ...
                                                            alertContent: localization.confirmDeleteEducation,
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  localization.addEducationEntry,
                                  style: TextStyle(
                                    fontSize: 14.sp,
                                    color: education.value != 1
                                      ? CommonColors.red
        ...
        //           showEducationAddModal();
        //         },
        //         child: const Text(localization.addEducationEntry),
        //       ),
