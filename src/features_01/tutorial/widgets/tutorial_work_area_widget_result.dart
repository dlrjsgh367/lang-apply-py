          ...
          body: CustomScrollView(
            slivers: [
                ...
                sliver: SliverToBoxAdapter(
                  child: Row(
                    children: [
                      Expanded(
                        child: Text(
                          localization.selectUpToTenDesiredWorkRegions,
                          style: TextStyle(
                            fontSize: 20.sp,
              ...
              SliverPadding(
                ...
                sliver: SliverToBoxAdapter(
                  child: Text(
                    localization.receiveSuggestionsOrSearchForJobPostsInRegion,
                    style: TextStyle(
                      fontSize: 14.sp,
              ...
              SliverPadding(
                ...
                sliver: SliverToBoxAdapter(
                  child: GestureDetector(
                    onTap: () async {
                      await DefineDialog.showAreaBottom(context, localization.regionSelection,
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            localization.setDesiredWorkRegions,
                            style: TextStyle(
                              fontSize: 14.sp,
              ...
              SliverPadding(
                ...
                sliver: SliverToBoxAdapter(
                  child: Row(
                    children: [
                      Text(
                        localization.selectedWorkRegions,
                        style: TextStyle(
                          fontSize: 14.sp,
                          color: CommonColors.gray80,
