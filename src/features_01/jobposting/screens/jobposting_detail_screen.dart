...
class _JobpostingDetailScreenState extends ConsumerState<JobpostingDetailScreen>
  ...
  String returnCareerCondition(
    ...
    if (conditionCareerEnum == ConditionCareerEnum.anyCareer) {
      ...
      result = '${ConditionCareerEnum.entry.label} $minCareer ~ $maxCareer ${localization.year}';


    } else {
      result = '${ConditionCareerEnum.experienced.label} $minCareer ~ $maxCareer ${localization.year}';
    }
    return result;
  }
