          ...
          children: [
            Scaffold(
              appBar: const CommonAppbar(
                title: localization.recruitmentConditions,
              ),
              body: Column(
                children: [
                  Expanded(
                    child: CustomScrollView(
                      slivers: [
                        ...
                        ProfileTitle(
                          title: localization.numberOfRecruits,
                          required: true,
                          text: '',
                          onTap: () {},
                          hasArrow: false,
                              ...
                              children: [
                                Expanded(
                                  child: ProfileRadio(
                                    ...
                                    value: false,
                                    label: localization.unspecifiedNumberOfRecruits,
                                  ),
                                ),
                                SizedBox(width: 8.w),
                                Expanded(
                          ...
                          SliverPadding(
                            ...
                            sliver: SliverToBoxAdapter(
                              child: TextFormField(
                                ...
                                maxLength: 2,
                                decoration: suffixInput(
                                  suffixText: localization.count,
                                  suffixColor: CommonColors.grayB2,
                                  suffixSize: 14.sp,
                                  hintText: localization.enterNumberOfRecruits,
                                ),
                                minLines: 1,
                                maxLines: 1,
                              ),
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      decoration: suffixInput(
                                        suffixText: localization.ageAbove,
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      maxLength: 2,
                                      decoration: suffixInput(
                                        suffixText: localization.ageBelow,
                                        suffixColor: CommonColors.black2b,
                                        suffixSize: 14.sp,
                        ...
                        PostingCheck(
                          ...
                          value: true,
                          label: localization.seniorHiring,
                        ),
                        const SliverDivider(),
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      textAlign: TextAlign.center,
                                      decoration: suffixInput(
                                        suffixText: localization.yearsAbove,
                                        suffixColor: CommonColors.black2b,
                                        suffixSize: 14.sp,
                                        hintText:
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      textAlign: TextAlign.center,
                                      decoration: suffixInput(
                                        suffixText: localization.yearsBelow,
                                        suffixColor: CommonColors.black2b,
                                        suffixSize: 14.sp,
                                        hintText:
                        ...
                        //TODO : 우대 조건
                        ProfileTitle(
                          title: localization.preferredConditions,
                          required: false,
                          text: '',
                          onTap: () {},
                          hasArrow: false,
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      localization.addPreferredConditions,
                                      style: TextStyle(
                                        fontSize: 14.sp,
                        ...
                        const SliverDivider(),
                        ProfileTitle(
                          title: localization.qualifications,
                          required: true,
                          text: '',
                          onTap: () {},
                          hasArrow: false,
