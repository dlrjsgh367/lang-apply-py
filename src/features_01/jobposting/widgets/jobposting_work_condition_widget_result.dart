    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return WorkPeriodBottomSheet(
          // CheckList: const ['하루 (1일)',localization.lessThanAWeek,localization.oneWeekToOneMonth,localization.oneMonthToThreeMonths,localization.threeToSixMonths,localization.sixMonthsToOneYear,localization.oneYearOrMore],
          // selected: 1,
          title: localization.employmentPeriod, dataArr: widget.workPeriodList,
          ...
          children: [
            Scaffold(
              appBar: const CommonAppbar(
                title: localization.workingConditions,
              ),
              body: CustomScrollView(
                slivers: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: CommonRadioTextButton(
                              ...
                              label: localization.monthlyWage,
                            ),
                          ),
                        ],
                      ),
                    ...
                    sliver: SliverToBoxAdapter(
                      child: TextFormField(
                        ...
                        decoration: commonInput(
                          hintText: localization.enterSalary,
                        ),
                        onChanged: (value) {},
                        inputFormatters: [
                  ...
                  PostingCheck(
                    ...
                    label: localization.negotiableSalary,
                  ),
                  const SliverDivider(),
                  ProfileTitle(
                    title: localization.workType,
                    required: true,
                    text: '',
                    onTap: () {},
                    hasArrow: false,
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: SelectButton(
                        ...
                        hintText: localization.selectWorkType,
                      ),
                    ),
                  ),
                  const SliverDivider(
                  ...
                  ProfileTitle(
                    title: localization.probationPeriod,
                    required: false,
                    text: '',
                    onTap: () {},
                    hasArrow: false,
                        ...
                        children: [
                          Expanded(
                            child: ProfileRadio(
                              ...
                              value: false,
                              label: localization.noProbationPeriod,
                            ),
                          ),
                      ...
                      sliver: SliverToBoxAdapter(
                        child: TextFormField(
                          ...
                          decoration: suffixInput(
                            ...
                            suffixText: localization.months,
                            hintText: localization.enterProbationPeriod,
                          ),
                          minLines: 1,
                          maxLines: 1,
                        ),
                  ...
                  PostingCheck(
                    ...
                    value: NegotiableEnum.possible,
                    label: localization.negotiableWorkDuration,
                  ),
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: EdgeInsets.fromLTRB(20.w, 0, 20.w, 0.w),
                      child: SelectButton(
                        ...
                        hintText: localization.selectWorkDuration,
                      ),
                    ),
                  ),
                  const SliverDivider(),
                  ...
                  PostingCheck(
                    ...
                    value: NegotiableEnum.possible,
                    label: localization.negotiableWorkingDays,
                  ),
                  SliverPadding(
                  ...
                  const SliverDivider(),
                  ProfileTitle(
                    title: localization.workingHours,
                    required: true,
                    text: '',
                    onTap: () {},
                    hasArrow: false,
                  ...
                  PostingCheck(
                    ...
                    value: NegotiableEnum.possible,
                    label: localization.negotiableWorkingHours,
                  ),
                  SliverPadding(
                    padding: EdgeInsets.fromLTRB(20.w, 0, 20.w, 8.w),
                    sliver: SliverToBoxAdapter(
                        ...
                        children: [
                          Row(
                            children: [
                              Expanded(
                                child: TimeInput(
                                  titleHint: localization.workStart,
                                  setFunc: (value) {
                              ...
                              Expanded(
                                child: TimeInput(
                                  titleHint: localization.workEnd,
                                  setFunc: (value) {
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Text(
                        localization.enterTimeIn24HourFormat,
                        style: TextStyle(
                          fontWeight: FontWeight.w500,
                          fontSize: 12.sp,
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Text(
                        localization.complyWithLegalMaxWorkingHours,
                        style: TextStyle(
                          fontWeight: FontWeight.w500,
                          fontSize: 12.sp,
                          color: CommonColors.grayB2,
                  ...
                  if (!isWorkTimeValidator(workHour))
                    SliverPadding(
                      ...
                      sliver: SliverToBoxAdapter(
                        child: Text(
                          localization.checkWorkingHours,
                  ...
                  PostingCheck(
                    ...
                    value: NegotiableEnum.possible,
                    label: localization.negotiableBreakTime,
                  ),
                  SliverPadding(
                    padding: EdgeInsets.fromLTRB(20.w, 0, 20.w, 0.w),
                    sliver: SliverToBoxAdapter(
                      ...
                      children: [
                        Expanded(
                          ...
                          decoration: commonInput(
                            hintText: localization.enterBreakTime,
                          ),
                          onChanged: (value) {
                            setState(() {
                        ...
                        Text(localization.minutesProvided,
                            style: TextStyle(
                              fontWeight: FontWeight.w500,
                              fontSize: 14.sp,
                              color: CommonColors.grayB2,
                  ...
                  const SliverDivider(),
                  ProfileTitle(
                    title: localization.regularWorkingHours,
                    required: true,
                    text: '',
                    onTap: () {},
                    hasArrow: false,
                    ...
                    sliver: SliverToBoxAdapter(
                      child: TextFormField(
                        ...
                        decoration: prefixInput(
                          prefixText: localization.week,
                          prefixColor: CommonColors.grayB2,
                          prefixSize: 14.sp,
                          hintText: localization.enterRegularWorkingHours,
                  ...
                  ProfileTitle(
                    title: localization.workplaceAddress,
                    required: true,
                    text: '',
                    onTap: () {},
                    hasArrow: false,
