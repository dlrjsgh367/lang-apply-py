...
class JobpostingPublishingWidget extends StatelessWidget {
  const JobpostingPublishingWidget(
      {required this.jobpostItem,
      required this.deleteJobposting,
        required this.closeJobposting,
  ...
  final Function closeJobposting;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                if (ConvertService.isNotEmptyValidate(jobpostItem.postPeriod))
                  PostingTag(
                    type: ConvertService.returnDiffDate(jobpostItem.postPeriod),
                    // type: widget.type,
                  ),
                SizedBox(
                  width: 8.w,
