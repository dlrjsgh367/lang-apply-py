...
class JobpostingCompleteCreateBottomsheet extends StatelessWidget {
  ...
  String messageContent(String type) {
    if (type == JobpostingEditEnum.create.path) {
      return localization.jobPostRegistrationCompleted;
    }
    if (type == JobpostingEditEnum.update.path) {
      return localization.jobPostEditCompleted;
    }
    if (type == JobpostingEditEnum.reregister.path) {
      return localization.jobPostReRegistrationCompleted;
    }
    return localization.networkConnectionUnstable;
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              localization.applyProductsForEmployers,
              ...
              child: Column(
                ...
                children: [
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                localization.findPerfectCandidateInOneDay,
                                style: TextStyle(
                                  fontSize: 12.sp,
                                  fontWeight: FontWeight.w500,
                                  color: CommonColors.gray66,
                      ...
                      children: [
                        Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                localization.highlightedInFiveRegions,
                                style: TextStyle(
                                  fontSize: 12.sp,
                                  fontWeight: FontWeight.w500,
                                  color: CommonColors.gray66,
                  ...
                  CommonButton(
                    ...
                    confirm: true,
                    text: localization.premiumShortcut,
                    width: CommonSize.vw,
                  )
                ],
              ),
