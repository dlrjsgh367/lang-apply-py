                          ...
                          child: Column(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(
                                    localization.vividParkSnowWorld,
                                  ...
                                  Text(
                                    localization.vivaldiSkiResortAndGolf,
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 1,
                                    style: TextStyle(
                                      fontSize: 14.sp,
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        localization.icheonCityIcheonDong,
                                        overflow: TextOverflow.ellipsis,
                                        maxLines: 1,
                                        style: TextStyle(
                                          fontSize: 12.w,
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        localization.threeMillionOneHundredTwentyThousandWon,
                                        overflow: TextOverflow.ellipsis,
                                        maxLines: 1,
                                        style: TextStyle(
                                          fontSize: 14.sp,
