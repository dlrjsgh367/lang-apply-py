...
class ThemeThumHalfDoubleHalfRowWidget extends ConsumerStatefulWidget {
  const ThemeThumHalfDoubleHalfRowWidget(
  ...
  @override
  ConsumerState<ThemeThumHalfDoubleHalfRowWidget> createState() =>
      _ThemeThumHalfDoubleHalfRowWidgetState();
}

class _ThemeThumHalfDoubleHalfRowWidgetState
    extends ConsumerState<ThemeThumHalfDoubleHalfRowWidget> {
  int activeIndex = 0;
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            ...
            (CommonSize.vw * 0.9111 / 2) / 4 * 3 + 28.w
                :
            (CommonSize.vw * 0.9111 / 2) / 4 * 3 * 2 + 28.w + 16.w
                :
                                            ...
                                            child: SizedBox(
                                              ...
                                              height: widget.themeData
                                                      ...
                                                      widget.themeData
                                                              .displayViewSummery ==
                                                          0
                                                  ? (CommonSize.vw * 0.9111 / 2 - 8.w - 8.w) / 4 * 3
                                                  : 70.w / 4 * 3,
                                            ...
                                            child: SizedBox(
                                              ...
                                              height: widget.themeData
                                                      ...
                                                      widget.themeData
                                                              .displayViewSummery ==
                                                          0
                                                  ? (CommonSize.vw * 0.9111 / 2 - 16.w) / 4 * 3
                                                  : 70.w / 4 * 3,
                                              child: ExtendedImgWidget(
                                                imgUrl: widget
                                                    .themeSettingList[
