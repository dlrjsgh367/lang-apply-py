...
class ThemeThumOutterOneHalfRowWidget extends ConsumerStatefulWidget {
  const ThemeThumOutterOneHalfRowWidget(
  ...
  @override
  ConsumerState<ThemeThumOutterOneHalfRowWidget> createState() =>
      _ThemeThumOutterOneHalfRowWidgetState();
}

class _ThemeThumOutterOneHalfRowWidgetState
    extends ConsumerState<ThemeThumOutterOneHalfRowWidget> {
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              if (widget.themeData
                                                  ...
                                                  1)
                                                Text(
                                                  '${widget.themeSettingList[index * 2 + i].summary}',
                                                  maxLines: 2,
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                  style: TextStyle(
