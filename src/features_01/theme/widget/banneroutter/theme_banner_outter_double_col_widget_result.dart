...
class ThemeBannerOutterDoubleColWidget extends ConsumerStatefulWidget {
  const ThemeBannerOutterDoubleColWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerOutterDoubleColWidget> createState() =>
      _ThemeBannerOutterDoubleColWidgetState();
}

class _ThemeBannerOutterDoubleColWidgetState
    extends ConsumerState<ThemeBannerOutterDoubleColWidget> {
        ...
        SliverPadding(
          ...
          sliver: SliverGrid(
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              (CommonSize.vw - 48.w) / 2 / 320 * 88 : (CommonSize.vw - 48.w) / 2 / 320 * 88 + 35.w,
            ),
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        height: (CommonSize.vw - 28.w) / 2 / 320 * 88,
