...
class ThemeBannerOutterOneRowWidget extends ConsumerStatefulWidget {
  const ThemeBannerOutterOneRowWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerOutterOneRowWidget> createState() =>
      _ThemeBannerOutterOneRowWidgetState();
}

class _ThemeBannerOutterOneRowWidgetState
    extends ConsumerState<ThemeBannerOutterOneRowWidget> {
  int activeIndex = 0;
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            ...
            (CommonSize.vw * 0.9166 - 10.w ) / 320 * 88 + 50.w + 20.w
