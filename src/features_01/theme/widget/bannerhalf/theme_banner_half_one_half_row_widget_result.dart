...
class ThemeBannerHalfOneHalfRowWidget extends ConsumerStatefulWidget {
  const ThemeBannerHalfOneHalfRowWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerHalfOneHalfRowWidget> createState() =>
      _ThemeBannerHalfOneHalfRowWidgetState();
}

class _ThemeBannerHalfOneHalfRowWidgetState
    extends ConsumerState<ThemeBannerHalfOneHalfRowWidget> {
  int activeIndex = 0;
