          ...
          return index == 0
              ? Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            localization.highlightTopCandidatesFast,
                    ...
                    Text(
                      localization.shortTermJobPremiumService,
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontSize: 15.sp,
              ...
              : Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        localization.myJobPostVisibilityBoost,
                        style: TextStyle(
                            fontSize: 14.sp,
                            fontWeight: FontWeight.w600,
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            localization.reachMoreCandidatesEasily,
                            style: TextStyle(
                              fontSize: 14.sp,
                            ),
                          ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            localization.lackTimeForSearchAndPost,
                            style: TextStyle(
                              fontSize: 14.sp,
                            ),
                          ),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            localization.consolidateJobPostViews,
                            style: TextStyle(
                              fontSize: 14.sp,
                            ),
                          ),
