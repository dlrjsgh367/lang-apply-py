      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertConfirmDialog(
            alertContent: localization.inquiryReceivedExpectResponseIn1To2Days,
                      ...
                      slivers: [
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        localization.brandThemeSectionExposure,
                                        style: TextStyle(
                                          fontSize: 13.sp,
                                      ...
                                      Text(
                                        localization.listStyleBannerExposure,
                                        style: TextStyle(
                                          fontSize: 13.sp,
                                          color: CommonColors.gray4d,
                                        ),
                        ...
                        SliverPadding(
                          ...
                          sliver: const ApplyTitle(
                            text: localization.brandThemeSectionInquiry,
                          ),
                        ),
                        SliverPadding(
                          ...
                          sliver: SliverToBoxAdapter(
                            child: Text(
                              localization.contactCustomerSupportForHelp,
                              style: TextStyle(
                                fontSize: 13.sp,
                                color: CommonColors.gray80,
                              ),
                        ...
                        SliverPadding(
                          ...
                          sliver: SliverToBoxAdapter(
                            ...
                            decoration: commonInput(hintText: localization.inquiryTitle),
                            ...
                            child: Stack(
                              children: [
                                TextFormField(
                                  ...
                                  decoration:
                                      areaInput(hintText: localization.enterInquiryContent),
                                  style: areaInputText(),
                                  onChanged: (value) {
                                    setState(() {
                          ...
                          sliver: SliverToBoxAdapter(
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    localization.unrelatedInquiryWarning,
                                    style: TextStyle(
                                      fontSize: 11.sp,
                                      color: CommonColors.red,
                                    ),
                            ...
                            child: Column(
                              ...
                              children: [
                                TermsItemWidget(
                                  isRequired: true,
                                  arrowNone: true,
                                  text: localization.privacyPolicyConsentNotice,
