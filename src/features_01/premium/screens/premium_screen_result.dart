      ...
      children: [
        ...
        Scaffold(
          ...
          appBar: const CommonAppbar(
            ...
            title: localization.premiumService,
          ),
          body: Stack(
            children: [
              !isLoading
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                            localization.myApplicationHistory,
                                            style: TextStyle(
                                                fontSize: 14.sp,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    localization.easyCrazyMatchingForPostsAndCandidateSearches,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: CommonColors.gray66,
                                    ),
                                  ...
                                  Text(
                                    localization.affordableHRConsultingExperience,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: CommonColors.gray66,
                                      fontWeight: FontWeight.w600,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    localization.highlightedRegionalJobPostsForMoreVisibility,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: CommonColors.gray66,
                                    ),
                                  ...
                                  Text(
                                    localization.increaseJobPostInterest,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: CommonColors.gray66,
                                      fontWeight: FontWeight.w600,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    localization.inAppBannerLinkForSpecializedThemePage,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: CommonColors.gray66,
                                    ),
                                  ...
                                  Text(
                                    localization.contactUsImmediately,
                                    style: TextStyle(
                                      fontSize: 13.sp,
                                      color: CommonColors.gray66,
                                      fontWeight: FontWeight.w600,
