              ...
              child: CustomScrollView(
                slivers: [
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Row(
                        children: [
                          Expanded(
                            child: Text(
                              localization.selectUpToFiveDesiredJobCategories,
                              style: TextStyle(
                                fontSize: 20.sp,
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Text(
                        localization.receiveSuggestionsForDesiredJobCategories,
                        style: TextStyle(
                          fontSize: 14.sp,
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                localization.setDesiredJobCategories,
                                style: TextStyle(
                                  fontSize: 14.sp,
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Row(
                        children: [
                          Text(
                            localization.selectedJobCategories,
                            style: TextStyle(
                              fontSize: 14.sp,
                              color: CommonColors.gray80,
