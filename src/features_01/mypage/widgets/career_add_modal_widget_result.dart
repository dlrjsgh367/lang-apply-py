          ...
          children: [
            Scaffold(
              appBar: const CommonAppbar(
                title: localization.addExperience,
              ),
              body: Column(
                    ...
                    child: CustomScrollView(
                      slivers: [
                        ...
                        ProfileTitle(
                          onTap: () {},
                          hasArrow: false,
                          title: localization.employmentPeriod,
                          required: true,
                          text: '',
                        ),
                        SliverPadding(
                        ...
                        ProfileTitle(
                          onTap: () {},
                          hasArrow: false,
                          title: localization.responsibilities,
                          required: true,
                          text: '',
                        ),
                        SliverPadding(
