        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertConfirmDialog(
              alertContent: localization.editCompleted,
          ...
          child: Column(
            children: [
              GestureDetector(
                ...
                child: const Text(localization.photoGallery),
              ),
              GestureDetector(
                onTap: () => getProfilePhoto('camera'),
                child: const Text(localization.takePhoto),
              ),
              GestureDetector(
                onTap: () => getProfileFile(),
                child: const Text(localization.fileSelect),
              ),
            ],
          ),
        );
      ...
      child: GestureDetector(
        ...
        child: Stack(
          children: [
            Scaffold(
              appBar: CommonAppbar(
                title: localization.editConsultation,
                backFunc: backEvent,
              ),
              body: isLoading
                  ? const Loader()
                  : CustomScrollView(
                      slivers: [
                        ...
                        TitleItem(title: localization.consultationContent),
                        SliverPadding(
                          padding: EdgeInsets.fromLTRB(20.w, 0, 20.w, 16.w),
                          sliver: SliverToBoxAdapter(
                            child: Stack(
                              children: [
                                TextFormField(
                                  ...
                                  decoration: areaInput(
                                    hintText: localization.enterInquiryContent,
                                  ),
                        ...
                        TitleItem(title: localization.attachment),
                        SliverPadding(
                          padding: EdgeInsets.fromLTRB(20.w, 0, 20.w, 16.w),
                          sliver: SliverToBoxAdapter(
                            child: Container(
                        ...
                        /*const TitleItem(title: localization.consultationResponse),
                        SliverPadding(
