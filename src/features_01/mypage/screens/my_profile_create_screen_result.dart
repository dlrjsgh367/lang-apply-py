...
class _MyProfileCreateScreenState extends ConsumerState<MyProfileCreateScreen>
  ...
  void saveFile(dynamic profilePhoto, dynamic file, int key) async {
    ...
    if (result == true) {
      setState(() {
        ...
        if (mounted) {
          context.pop();
          showDefaultToast(localization.profileRegistrationCompleted);
        }
      });
    } else {
      if (mounted) {
  ...
  String mergeStrings(String leftKey, String rightKey, Function leftConvertFunc,
    ...
    if (leftString.isNotEmpty && rightString.isNotEmpty) {
      ...
      result = localization.detailedInputImprovesProposalChances;
    }
    return result;
  }
  ...
  showBasicProfileAlert(BuildContext context) {
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertTwoButtonDialog(
            alertTitle: localization.changeRepresentativeProfile,
            alertContent: localization.confirmRepresentativeProfileChange,
            alertConfirm: localization.change,
            alertCancel: localization.cancel,
            onConfirm: () {
              context.pop(context);
              createProfile();
    ...
    if (result.status == 200 && result.type == 1) {
      ...
      if (mounted) {
        if (result.status == 401) {
          showDefaultToast(localization.prohibitedWordDetected);
        } else if (result.status == 412) {
          showDefaultToast(localization.exceededMaxProfileLimit);
        } else {
          showDefaultToast(localization.profileRegistrationFailedRetry);
        }
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: CommonAppbar(
            title: localization.newProfileRegistration,
            backFunc: () {
              showCancelDialog();
            },
          ),
              ...
              ? CustomScrollView(
                  slivers: [
                    ...
                    ProfileListItemWidget(
                      ...
                      title: localization.desiredWorkRegion,
                      content: selectedAreaList.isNotEmpty
                          ? null
                          : localization.proposalFromOrSearchInRegion,
                    ),
                    ...
                    ProfileListItemWidget(
                      isRequire: true,
                      onTap: () => showJobAlert(),
                      title: localization.desiredJobCategory,
                      content: selectedJobList.isNotEmpty
                          ? null
                          : localization.proposalForDesiredJobCategory,
                    ),
                    ...
                    ProfileListItemWidget(
                      ...
                      content: profileData['educationList'].isNotEmpty
                          ? null
                          : localization.educationImprovesJobSupport,
                    ),
                    ...
                    ProfileListItemWidget(
                      ...
                      title: localization.selfIntroduction,
                      ...
                      content: profileData['mpIntroduce'].isNotEmpty ||
                          ...
                          ? null
                          : localization.highlightUniqueStrengths,
                    ),
                    ...
                    ProfileListItemWidget(
                      ...
                      content: fileData['file'] != null &&
                          ...
                          ? null
                          : localization.useAttachmentsForSelfPR,
                    ),
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Text(
                          localization.receiveJobProposals,
                          style: TextStyle(
                            fontWeight: FontWeight.w600,
                            color: CommonColors.black2b,
                          ),
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverToBoxAdapter(
                        child: ProfileRadio(
                          ...
                          label: localization.acceptAllProposals,
                        ),
                      ),
                    ),
                    SliverPadding(
                      ...
                      sliver: SliverToBoxAdapter(
                        child: ProfileRadio(
                          ...
                          label: localization.acceptOnlyPreferredProposals,
                        ),
                      ),
                    ),
                    SliverPadding(
                      ...
                      sliver: SliverToBoxAdapter(
                        child: ProfileRadio(
                          ...
                          label: localization.declineAllProposals,
                        ),
                      ),
                    ),
                    SliverPadding(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      localization.setProfileAsRepresentative,
                                      style: TextStyle(
