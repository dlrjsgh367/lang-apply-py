  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CommonAppbar(
        title: localization.laborConsultation,
      ),
                    ...
                    slivers: [
                      SliverPadding(
                        ...
                        sliver: SliverToBoxAdapter(
                          child: Text(
                            localization.laborRelationsAnalysisAndRecommendations,
                            style: TextStyle(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    localization.submitConsultation,
                                    style: TextStyle(
                      ...
                      SliverPadding(
                        ...
                        sliver: SliverToBoxAdapter(
                          child: Row(
                            children: [
                              Text(
                                localization.consultationHistory,
                                style: TextStyle(
                                    fontWeight: FontWeight.w600,
                                    color: CommonColors.black2b),
                              ),
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(
                                              localization.myConsultationHistory,
                                              style: TextStyle(
                                                  fontSize: 14.sp,
                                                  fontWeight: FontWeight.w500,
                      ...
                      boardList.isNotEmpty
                                                ...
                                                children: [
                                                  boardList[index].boStatus ==
                                                      ...
                                                      ? Container(
                                                          ...
                                                          child: Text(
                                                            localization.responseCompleted,
                                                            style: TextStyle(
                                                              fontSize: 12.sp,
                                                              fontWeight:
                                                                  FontWeight
                          ...
                          : SliverToBoxAdapter(
                              child: SizedBox(
                                  ...
                                  child: Center(
                                      child: CommonEmpty(text: localization.noConsultationHistory))),
                            ),
                      const BottomPadding(),
                    ],
                  ),
