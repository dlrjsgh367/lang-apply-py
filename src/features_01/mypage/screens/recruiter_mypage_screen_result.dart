...
class _RecruiterMypageScreenState extends ConsumerState<RecruiterMypageScreen>
  ...
  getJobpostingListData(int page, Map<String, dynamic> params) async {
    ...
    if (result.status == 200) {
      if (result.type == 1) {
        ...
        if (publishingJobpostingTotal > 0 && userInfo.memberStatus == localization.notHired) {
          updateHiringStatus();
        }
      }
    }
  ...
  void openShare(String url) async {
    showDefaultToast(localization.copiedSuccessfully);
    final result = await Share.share(
        await dynamicLink.generateLink(context, url),
        subject: localization.shortTermJob);
    if (result.status == ShareResultStatus.success) {
      showDefaultToast(localization.sharingCompleted);
    }
  }
    ...
    return PopScope(
        ...
        child: Scaffold(
          appBar: RedAppbar(
            ...
            setTab: setTab,
            activeTab: activeTab,
            tabTitleArr: const ['마이페이지', localization.settings],
          ),
                      ...
                      slivers: [
                                      ...
                                      child: ColoredBox(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Text(
                                              localization.recentlyViewedCandidate,
                                              style: TextStyle(
                                                  fontSize: 12.sp,
                                                  fontWeight: FontWeight.w500,
                                                  color: CommonColors.gray66),
                                ...
                                Expanded(
                                  child: CommonButton(
                                    ...
                                    childWidget: Row(
                                      ...
                                      children: [
                                        Text(
                                          localization.urgentRecruitment,
                                          style: TextStyle(
                                            fontSize: 12.sp,
                                            color: CommonColors.white,
                                            fontWeight: FontWeight.w500,
                        ...
                        SliverToBoxAdapter(
                          child: MoveButton(
                            ...
                            text: localization.manageJobPosts,
                          ),
                        ),
                        SliverToBoxAdapter(
                          child: MoveButton(
                            ...
                            text: localization.premiumService,
                          ),
                        ),
                        SliverToBoxAdapter(
                          child: MoveButton(
                            ...
                            text: localization.laborConsultation,
                          ),
                        ),
                        SliverToBoxAdapter(
                          child: MoveButton(
                            ...
                            text: localization.contractOrResignationLetter,
                          ),
                        ),
                        SliverToBoxAdapter(
                          child: MoveButton(
                            ...
                            text: localization.starRatingManagement,
                          ),
                        ),
                        SliverToBoxAdapter(
                          child: MoveButton(
                            ...
                            text: localization.activityPointsManagement,
                          ),
                        ),
                        SliverPadding(
                          ...
                          sliver: SliverToBoxAdapter(
                            child: Column(
                              children: [
                                CommonButton(
                                  ...
                                  childWidget: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        localization.inviteEmployersRewarded,
                                ...
                                Text(
                                  localization.rewardConditionsForInvitations,
                                  style: TextStyles.commonButton(
                                      color: CommonColors.gray4d, fontSize: 10),
                                ),
                                Text(
                                  localization.rewardLimitationsForRejoiningMembers,
                                  style: TextStyles.commonButton(
