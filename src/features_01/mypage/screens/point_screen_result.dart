  ...
  returnPointType(String type) {
    switch (type) {
      ...
      case 'PROFILE_JOBSEEKER':
        return localization.registerProfile;
      case 'SCRAP_JOB_POSTING':
        return localization.scrapJobPost;
      case 'ADD_COMPANY_LIKES':
        return localization.addFavoriteCompany;
      case 'SHARE_JOB_POSTING':
        return localization.shareJobPost;
      case 'APPLY_JOB':
        return localization.applyForJob;
      case 'VIEW_JOB_POSTING':
        return localization.viewJobPost;
      case 'LOGIN_RECRUITER':
        return localization.login;
      case 'CREATE_COMPANY_INFO':
        return localization.registerCompanyInfo;
      case 'CREATE_JOB_POSTING':
        return localization.registerJobPost;
      case 'VIEW_JOBSEEKER':
        return localization.browseCandidates;
      case 'OFFER_JOB':
        return localization.makeJobProposal;
      case 'ADD_JOBSEEKER_LIKES':
        return localization.addFavoriteCandidate;
      case 'INVITE':
        return localization.invite;
      case 'INVITE_SUCCESS':
        return localization.invitationSuccessful;
      case 'COMPLETE_RATING':
        return localization.starRatingCompleted;
      case 'WRITE_LABOR_CONSULT':
        return localization.writeLaborConsultation;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CommonAppbar(
        title: localization.activityPointsManagement,
      ),
        ...
        child: !isLoading
            ? CustomScrollView(
                slivers: [
                  ...
                  TitleMenu(title: localization.activityPointsHistory),
                  SliverPadding(
                        ...
                        : SliverToBoxAdapter(
                            child: SizedBox(
                              height: CommonSize.vh / 2,
                                child: const CommonEmpty(text: localization.noActivityHistory)),
                          ),
                  ),
                  const BottomPadding(),
