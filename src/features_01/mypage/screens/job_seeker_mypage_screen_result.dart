    ...
    return PopScope(
        ...
        child: Scaffold(
          appBar: RedAppbar(
            ...
            setTab: setTab,
            activeTab: activeTab,
            tabTitleArr: ['마이페이지', localization.settings],
          ),
                      ...
                      slivers: [
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  localization.profileManagement,
                                                  style: TextStyle(
                                                      fontSize: 11.sp,
                                                      color:
                                                          CommonColors.gray66,
                                      ...
                                      child: ColoredBox(
                                        ...
                                        child: Column(
                                          ...
                                          height: 20.w,
                                            ...
                                            // iconRedClock.png
                                            Text(
                                              localization.recentlyViewedJobPosts,
                                              style: TextStyle(
                                                  fontSize: 12.sp,
                                                  fontWeight: FontWeight.w500,
                                                  color: CommonColors.gray66),
                                      ...
                                      child: ColoredBox(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            // iconRedClock.png
                                            Text(
                                              localization.favoriteCompanies,
                                              style: TextStyle(
                                                  fontSize: 12.sp,
                                                  fontWeight: FontWeight.w500,
                                                  color: CommonColors.gray66),
                        ...
                        SliverToBoxAdapter(
                          child: MoveButton(
                            ...
                            text: localization.employmentCertificateIssued,
                          ),
                        ),
                        SliverToBoxAdapter(
                          child: MoveButton(
