    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertConfirmDialog(
            ...
            alertContent: localization.noCorrespondingChatRoom,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CommonAppbar(
        title: localization.contractOrResignationLetter,
      ),
      body: Column(
        ...
        children: [
          ...
          if (activeTab == 0)
            ...
            contractList.isNotEmpty
              ...
              child: LazyLoadScrollView(
                ...
                child: const CommonEmpty(text: localization.noContractRegistered))
                : SizedBox(
                width: CommonSize.vw,
                height: (CommonSize.vh - CommonSize.commonBottom - 12.w)/ 3,
                child: const Loader()),
          ...
          ?
            resignationLetterList.isNotEmpty
                ...
                child: const CommonEmpty(text: localization.noResignationRegistered))
            : SizedBox(
                width: CommonSize.vw,
