  ...
  createBoard() async {
    ...
    if (result.status == 200 && result.type == 1) {
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertConfirmDialog(
                alertContent: localization.registeredSuccessfully,
      ...
      if (result.status == 401 && result.type == -2001) {
        ...
        showDefaultToast(localization.postCreationFailed);
      }
    }
  }
        ...
        child: Stack(
          children: [
            Scaffold(
              ...
              appBar: CommonAppbar(
                title: localization.createConsultation,
                backFunc: () {
                  showCancelDialog();
                },
              ),
              body: CustomScrollView(
                slivers: [
                  const TitleItem(title: localization.consultationTitle),
                  SliverPadding(
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Stack(
                        ...
                        TextFormField(
                            ...
                            style: areaInputText(),
                            decoration: areaInput(hintText: localization.enterConsultationContent),
                  ...
                  const TitleItem(title: localization.setPrivatePost),
                  SliverPadding(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                localization.confirmPrivatePostSetting,
                                style: TextStyle(
                                  fontWeight: FontWeight.w500,
                                  fontSize: 14.sp,
                                  color: CommonColors.black2b,
            ...
            Positioned(
              ...
              child: CommonButton(
                ...
                text: localization.submitConsultation,
                confirm: setConfirm(),
              ),
            ),
          ],
