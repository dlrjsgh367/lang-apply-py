...
class RecommendSilverFilterWidget extends ConsumerStatefulWidget {
  RecommendSilverFilterWidget(
      {super.key,
  ...
  @override
  ConsumerState<RecommendSilverFilterWidget> createState() => _AlbaFilterState();
}

class _AlbaFilterState extends ConsumerState<RecommendSilverFilterWidget> {
  int maxLength = 10;
  ...
  static const String HAVE_CAREER = 'jpCareerType';
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    DefineDialog.showAreaBottom(context, localization.regionSelection, areaList,
