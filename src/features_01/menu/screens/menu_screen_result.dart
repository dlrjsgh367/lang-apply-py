    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          TitleMenu(title: localization.announcementEvent),
          BtnMenu(
            text: localization.announcement,
            tabFunc: () {
              context.push('/notice');
            },
          ),
          ...
          TitleMenu(title: localization.customerSupport),
          BtnMenu(
            text: localization.customerSupport,
            tabFunc: () {
              context.push('/qna');
            },
          ),
          ...
          BtnMenu(
            text: localization.locationBasedServiceTerms,
            tabFunc: () {
          ...
          TitleMenu(title: localization.appInfo),
          VersionMenu(
            version: version,
            tabFunc: () {
              openStore();
