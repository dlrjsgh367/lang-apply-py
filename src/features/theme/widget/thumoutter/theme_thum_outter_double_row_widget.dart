...
class ThemeThumOutterDoubleRowWidget extends ConsumerStatefulWidget {
  const ThemeThumOutterDoubleRowWidget(
  ...
  @override
  ConsumerState<ThemeThumOutterDoubleRowWidget> createState() =>
      _ThemeThumOutterDoubleRowWidgetState();
}

class _ThemeThumOutterDoubleRowWidgetState
    extends ConsumerState<ThemeThumOutterDoubleRowWidget> {
  var imgHeight = (CommonSize.vw * 0.9111 - 10.w) * 0.75;
  var titleHeight = 28.w;
  var textHeight = 42.w;
