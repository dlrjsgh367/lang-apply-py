...
class ThemeThumInnerDoubleHalfRowWidget extends ConsumerStatefulWidget {
  const ThemeThumInnerDoubleHalfRowWidget(
  ...
  @override
  ConsumerState<ThemeThumInnerDoubleHalfRowWidget> createState() =>
      _ThemeThumInnerDoubleHalfRowWidgetState();
}

class _ThemeThumInnerDoubleHalfRowWidgetState
    extends ConsumerState<ThemeThumInnerDoubleHalfRowWidget> {
  int activeIndex = 0;
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            ...
            (CommonSize.vw * 0.9111 / 2 - 8.w) / 4 * 3 + 20.w
            :
            (CommonSize.vw * 0.9111 / 2 - 8.w) / 4 * 3 * 2 + 20.w + 8.w,
            child: Swiper(
                          ...
                          children: [
                            if (widget.themeSettingList.length >
                              ...
                              SizedBox(
                                ...
                                height:
                                    (CommonSize.vw * 0.9111 / 2 - 8.w) / 4 * 3,
                                child: Padding(
