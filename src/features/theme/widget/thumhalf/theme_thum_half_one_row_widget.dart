...
class ThemeThumHalfOneRowWidget extends ConsumerStatefulWidget {
  const ThemeThumHalfOneRowWidget(
  ...
  @override
  ConsumerState<ThemeThumHalfOneRowWidget> createState() =>
      _ThemeThumHalfOneRowWidgetState();
}

class _ThemeThumHalfOneRowWidgetState
    extends ConsumerState<ThemeThumHalfOneRowWidget> {
  int activeIndex = 0;
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            height: widget.themeData.displayViewTitle == 0 &&
                ...
                ? (CommonSize.vw * 0.9166 - 10.w - 24.w) / 4 * 3 + 28.w
                : 112.w / 4 * 3 + 28.w,
            child: Swiper(
