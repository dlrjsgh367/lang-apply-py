...
class ThemeBannerOutterDoubleRowWidget extends ConsumerStatefulWidget {
  const ThemeBannerOutterDoubleRowWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerOutterDoubleRowWidget> createState() =>
      _ThemeBannerOutterDoubleRowWidgetState();
}

class _ThemeBannerOutterDoubleRowWidgetState
    extends ConsumerState<ThemeBannerOutterDoubleRowWidget> {
  int activeIndex = 0;
      ...
      slivers: [
        ...
        SliverToBoxAdapter(
          child: SizedBox(
            ...
            (CommonSize.vw * 0.9166 - 10.w) / 320 * 88 + 90.w + 20.w :
            (CommonSize.vw * 0.9166 - 10.w) / 320 * 88 * 2 + 90.w + 10.w + 20.w
            :
            widget.themeSettingList.length < 2 ?
            (CommonSize.vw * 0.9166 - 10.w) / 320 * 88 + 20.w
                : (CommonSize.vw * 0.9166 - 10.w) / 320 * 88 * 2 + 10.w + 20.w,
            child: Swiper(
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(
                                height: (CommonSize.vw * 0.9166 - 10.w) / 320 *
                                    88,
                              ...
                              if(widget.themeData.displayViewTitle == 1)
                                Padding(
                                  ...
                                  child: Text(widget
                                      .themeSettingList[index * 2].title,
                                    maxLines: 1,
