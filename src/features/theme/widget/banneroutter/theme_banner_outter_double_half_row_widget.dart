...
class ThemeBannerOutterDoubleHalfRowWidget extends ConsumerStatefulWidget {
  const ThemeBannerOutterDoubleHalfRowWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerOutterDoubleHalfRowWidget> createState() =>
      _ThemeBannerOutterDoubleHalfRowWidgetState();
}

class _ThemeBannerOutterDoubleHalfRowWidgetState
    extends ConsumerState<ThemeBannerOutterDoubleHalfRowWidget> {
  int activeIndex = 0;
          ...
          child: SizedBox(
            ...
            height: widget.themeData.displayViewTitle == 1
                ? widget.themeSettingList.length < 2
                    ? (CommonSize.vw * 0.9111 / 2 - 8.w) / 320 * 88 +
                        70.w +
                        30.w
                    : (CommonSize.vw * 0.9111 / 2 - 8.w) / 320 * 88 * 2 +
                        70.w +
                        30.w
                : widget.themeSettingList.length < 2
                    ? (CommonSize.vw * 0.9111 / 2 - 8.w) / 320 * 88 + 30.w
