...
class ThemeBannerHalfDoubleRowWidget extends ConsumerStatefulWidget {
  const ThemeBannerHalfDoubleRowWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerHalfDoubleRowWidget> createState() =>
      _ThemeBannerHalfDoubleRowWidgetState();
}

class _ThemeBannerHalfDoubleRowWidgetState
    extends ConsumerState<ThemeBannerHalfDoubleRowWidget> {
  int activeIndex = 0;
          ...
          child: SizedBox(
            ...
            height: widget.themeData.displayViewTitle == 1
                ...
                : widget.themeSettingList.length < 2
                    ...
                    : (CommonSize.vw * 0.9166 - 10.w) / 320 * 88 * 2 +
                        20.w +
                        10.w,
            child: Swiper(
                    ...
                    children: [
                              ...
                              if (widget.themeData.displayViewTitle == 1)
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      widget.themeSettingList[index * 2].title,
                                      maxLines: 1,
                      ...
                      if (widget.themeSettingList.length > index * 2 + 1)
                        GestureDetector(
                          onTap: () {
                            widget.moveUrl(
                                widget.themeSettingList[index * 2 + 1]);
                          },
                          child: Container(
                            clipBehavior: Clip.hardEdge,
                            decoration: BoxDecoration(
