...
class ThemeBannerInnerDoubleColWidget extends ConsumerStatefulWidget {
  const ThemeBannerInnerDoubleColWidget(
      {super.key,
  ...
  @override
  ConsumerState<ThemeBannerInnerDoubleColWidget> createState() =>
      _ThemeBannerInnerDoubleColWidgetState();
}

class _ThemeBannerInnerDoubleColWidgetState
    extends ConsumerState<ThemeBannerInnerDoubleColWidget> {
        ...
        SliverPadding(
          ...
          sliver: SliverGrid(
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                ...
                mainAxisExtent:(CommonSize.vw - 48.w) / 2 / 320 * 88,
            ),
                  ...
                  Stack(
                    children: [
                      SizedBox(
                        ...
                        height: (CommonSize.vw - 48.w) / 2 / 320 * 88,
                        ...
                        child: ClipRRect(
                          child: BackdropFilter(
                            ...
                            child: Container(
                              ...
                              padding:
                                  EdgeInsets.fromLTRB(12.w, 2.w, 12.w, 2.w),
                              child: Text(
                                theme.title,
                                maxLines: 1,
